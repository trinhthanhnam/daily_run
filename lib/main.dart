...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final height = MediaQuery.sizeOf(context).height;flu
    final O3D character = O3D(
      src: 'assets/quadbike_rider.glb',
      controller: o3dController,
      ar: false,
      autoPlay: true,
      autoRotate: false,
      cameraControls: false,
      loading: Loading.values.first,
      cameraTarget: CameraTarget(0, 0.9, 0),
      cameraOrbit: CameraOrbit(0, 90, 1.5),
    );
    // Future.delayed(const Duration(seconds: 1)).then((val) {
    //   character.runtimeType;
    // });
    return Scaffold(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Padding(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Simple way to health is walking',
                                style: TextStyle(
      ...
      bottomNavigationBar: BottomNavigationBar(
          ...
          onTap: (page) {
            ...
            if (page == 0) {
              o3dController.cameraTarget(0, 0.4, 0);
              o3dController.cameraOrbit(0, 90, 1.5);
            } else if (page == 1) {
              o3dController.cameraTarget(0, 0.4, 0);
          ...
          items: const [
            BottomNavigationBarItem(
                icon: Icon(Icons.analytics_outlined), label: 'anlytics'),
            BottomNavigationBarItem(
